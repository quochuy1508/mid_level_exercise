...
namespace Magenest\DeliveryDate\Plugin\Checkout\Block;

use Magenest\DeliveryDate\Model\Config;
...
class LayoutProcessor
{
    ...
    public function afterProcess(
        ...
        ['shippingAddress']['children']['shippingAdditional'] = [
            ...
            'children' => [
                'delivery_date' => [
                    'component' => 'Magenest_DeliveryDate/js/view/delivery-date-block',
                    ...
                    'children' => [
                        'form-fields' => [
                            ...
                            'children' => [
                                'delivery_date' => [
                                    'component' => 'Magenest_DeliveryDate/js/view/delivery-date',
                                    'config' => [
                                        'customScope' => 'delivery_date',
                                        'template' => 'ui/form/field',
                                        'elementTmpl' => 'Magenest_DeliveryDate/fields/delivery-date',
                                        'options' => [],
                                        'id' => 'delivery_date',
